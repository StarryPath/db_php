...
$query = "SELECT  student_info.sno,sclass,sname,year,term,grade,sage,ssex,saddr from student_info   left   join   grade_info     on  student_info.sno=grade_info.sno where (ssex =?)";
//echo $query;
