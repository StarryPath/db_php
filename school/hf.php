...
<style type="text/css">
 ...
 <h1>数据库恢复</h1>  
 <br><br>
  <form action="check_hf.php" method="post" target="nm_iframe">
<div class="form-group">
<label for="name">数据库名</label>
<input type="text" class="form-control" name="db_name" placeholder="请输入恢复的数据库名">
</div>
<div class="form-group">
    <label for="inputfile"></label>
    <input type="file" id="inputfile" name="path">
    <p class="help-block">选择备份文件</p>
  </div>
<table>
